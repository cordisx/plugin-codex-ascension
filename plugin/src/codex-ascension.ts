  ...
  stages: [
    {
      ...
      portrait: {
        mediaType: 'image/png',
        data: plasticPortrait,
        alt: { key: 'portrait.plastic', fallback: 'Tibo as the exhausted scribe' },
      },
    },
    {
      material: 'bronze',
      ...
      portrait: {
        mediaType: 'image/png',
        data: bronzePortrait,
        alt: { key: 'portrait.bronze', fallback: 'Tibo as the night builder' },
      },
    },
    {
      material: 'steel',
      ...
      portrait: {
        mediaType: 'image/png',
        data: steelPortrait,
        alt: { key: 'portrait.steel', fallback: 'Tibo as the agent commander' },
      },
    },
    {
      material: 'silver',
      ...
      portrait: {
        mediaType: 'image/png',
        data: silverPortrait,
        alt: { key: 'portrait.silver', fallback: 'Tibo as the consul of code' },
      },
    },
    {
      material: 'gold',
      ...
      portrait: {
        mediaType: 'image/png',
        data: goldPortrait,
        alt: { key: 'portrait.gold', fallback: 'Tibo as Codex Maximus' },
      },
    },
  ],
